  ...
  const features = [
    {
      ...
      description:
        "Certificates are stored on immutable blockchain networks, ensuring they cannot be tampered with or forged.",
    ...
    },
    {
      ...
      description:
        "Verify any certificate in seconds using our GraphQL-powered verification system.",
    ...
    },
    {
      ...
      description:
        "Automatically selects the most cost-effective blockchain using Chainbase Gas Tracker API.",
    ...
    },
    {
      ...
      description:
        "Secure zero-knowledge authentication ensures privacy while maintaining verification integrity.",
    ...
    },
    {
      ...
      description:
        "Support for issuers, verifiers, and certificate holders with role-based access control.",
    ...
    },
    {
      ...
      description:
        "Track certificate issuance, verification rates, and blockchain network performance.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            user-friendly design to create the most secure and efficient
