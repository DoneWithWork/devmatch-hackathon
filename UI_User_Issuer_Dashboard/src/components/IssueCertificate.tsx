  ...
  return (
    <div className="pt-24 pb-12 min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-100/50 to-purple-100/50 backdrop-blur-sm border border-white/30 mb-6">
            <Award className="h-5 w-5 text-blue-600 mr-2" />
            <span className="text-blue-700 font-medium">Issue New Certificate</span>
          </div>
          <h1 className="text-4xl font-bold text-gray-800 mb-4">Create Blockchain Certificate</h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Issue tamper-proof certificates on the blockchain with automatic gas optimization
          </p>
        </motion.div>
                  ...
                  {blockchains.map((blockchain) => (
                    ...
                    >
                      <input
                        ...
                        name="blockchain"
                        value={blockchain.id}
                        checked={formData.blockchain === blockchain.id}
                        onChange={handleInputChange}
                        className="sr-only"
                      />
