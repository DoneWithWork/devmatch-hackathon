          ...
          >
            <div className="space-y-4">
              ...
              >
                ...
                <span className="text-sm font-medium text-blue-700">Powered by Blockchain Technology</span>
              </motion.div>
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
                Issue and verify certificates on the blockchain with zero-knowledge authentication. 
                Transparent, secure, and tamper-proof certification system.
              </p>
            </div>
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="font-semibold text-gray-800">Digital Certificate</div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="font-mono text-sm text-gray-800">0x1a2b3c4d5e6f...</div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="font-semibold text-gray-800">Blockchain Development</div>
                  </div>
