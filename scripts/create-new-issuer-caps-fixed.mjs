...
async function createNewIssuerCapabilities() {
  ...
  // Query the database for applications with these issuer cap IDs and join with users to get wallet address
  ...
  applications.forEach((app) => {
    ...
    console.log(
      `  Applicant ID: ${app.applicant_id}, Wallet: ${app.user_address}, Email: ${app.contact_email}`
    );
  });
